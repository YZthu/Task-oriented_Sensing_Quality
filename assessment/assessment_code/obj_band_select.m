function mse = obj_band_select(low_up_ba, training_factor, train_acc)
...
th_combin = [low_bd; up_bd];%[low_up_band(1: szie(training_factor,2));low_up_band(szie(training_factor,2)+1:end)];
