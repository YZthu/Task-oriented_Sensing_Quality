...
load('recall_test_train_set.mat');
...
for app_num=1:2        % 1 cl classification 2 sd detection
    ...
    %delete 1 3 10 11 environment
    del_dep =[1,2,3,4,9,10,11,12, 37:48];
    all_Acc_M(:, del_dep) =[];
    ...
    for train_num= 1%:length(train_dep_number)
        ...
        eval(['full_train_st = recall_train;']);
        ...
        train_case_number = size(full_train_st,1);
