function solve = weight_st_gradient_descent(low_initial, up_initial, w0, training_factor, train_acc,full_test_Met, test_acc)
...
solution_x =[];
for iteration=1:200
    grad = weight_st_object_function_grid(xk, training_factor, train_acc);
    % find the step length
    alpha =1;
    f0 =weight_st_Ojbect_function(xk, training_factor, train_acc);
    g0 = grad';
    ...
    %if exitflag >2
        xk1 = xk + alpha * pk;
        fk1 = weight_st_Ojbect_function(xk1, training_factor, train_acc);
    %end
    ...
    xk = xk1;
    fk1 = weight_st_Ojbect_function(xk, training_factor, train_acc);
    tmp_test_loss = weight_st_Ojbect_function(xk, full_test_Met, test_acc);
