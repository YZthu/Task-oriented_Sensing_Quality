function [final_th, final_weight] = data_driven_threshold_selection_part_gd(training_factor, train_acc,full_test_Met, test_acc)
...
for evaluat_n = 1
    ...
    up_initial = max_val;%up_band_condidate(evaluat_n,:);
    low_initial = min_val;%low_band_condidate(evaluat_n,:);
    ...
    each_set = buffer(cross_gr,5);
        ...
        best_sol = part_gradient_descent(low_initial, up_initial, w0', training_factor, train_acc,full_test_Met, test_acc);
