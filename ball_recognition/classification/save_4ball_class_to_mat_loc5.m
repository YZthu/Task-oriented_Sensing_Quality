...
%location 5
Acc_M1 =[
0.925	0.975	1	0.9	0.825	0.85	0.614285714	0.975	1
0.9	0.975	1	0.8	0.825	0.8	0.660714286	0.95	1
];

Acc_M2 = [
0.95	0.975	1	0.9	0.9	0.775	0.825	0.95	1
0.925	0.975	1	0.85	0.9	0.75	0.75	0.975	1
];

Acc_M3 =[
0.95	0.9	1	0.925	0.975	0.925	0.7	0.975	0.925
0.95	0.875	1	0.925	0.975	0.95	0.725	0.925	0.95
];

Acc_M4 =[
0.975	0.675	0.975	0.95	1	0.925	0.425	0.95	0.975
0.95	0.45	0.95	0.95	1	0.925	0.45	0.95	0.875
];
...
location5 = classification_accuracy;
save('classification_acc.mat', 'location5','-append');
