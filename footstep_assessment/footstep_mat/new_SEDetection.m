function [ stepEventsSig, stepEventsIdx, stepEventsVal, ...
            ...
            windowEnergyArray, noiseMu, noiseSigma, noiseRange,th ] = new_SEDetection( rawSig, noiseSig, sigma_th, winsize)

    % this function extract the footsteps from a signal segment
    
    windowSize = winsize;%1200
    WIN1=1000;%500
    WIN2=500;
    offSet = 100;
    eventSize = WIN1+WIN2;
    sigmaSize = sigma_th;
    blackman_w = blackmanharris(windowSize);
    ...
    while idx < length(noiseSig) - max(windowSize, eventSize) - 10
         ...
         windowDataEnergy = windowData.^2 *blackman_w;
