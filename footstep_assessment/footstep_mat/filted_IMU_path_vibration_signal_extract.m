function [available_num, tmp_footstep_set,raw_path_vs, fin_selected_sig_loc,current_IMU_path_loc] = ...
    filted_IMU_path_vibration_signal_extract(raw_vs, filted_vs, IMU_path, fil_bck, raw_bck, signal_th, nx)
...
IMU_str = nx(start:stop);
 ...
 [ stepEventsSig, stepEventsIdx, stepEventsVal, ...
            ...
            windowEnergyArray, noiseMu, noiseSigma, noiseRange ,th] = SEDetection( current_filted_data, fil_bck, 4);
